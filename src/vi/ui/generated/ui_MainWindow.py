...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/Icons/res/volume.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionActivateSound.setIcon(icon1)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Icons/res/restoreframe.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionFramelessWindow.setIcon(icon2)
        ...
        self.actionUseSpokenNotifications.setIcon(icon3)
        ...
        icon4 = QIcon()
        icon4.addFile(u":/Icons/res/arrows-rotate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionRescanIntelNow.setIcon(icon4)
        self.actionClearIntelChat = QAction(MainWindow)
        self.actionClearIntelChat.setObjectName(u"actionClearIntelChat")
        icon5 = QIcon()
        icon5.addFile(u":/Icons/res/trash-box.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionClearIntelChat.setIcon(icon5)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/Icons/res/search.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.searchSystem.setIcon(icon7)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/Icons/res/locate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.locateChar.setIcon(icon8)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/Icons/res/plus.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/Icons/res/minus.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        icon11 = QIcon()
        icon11.addFile(u":/Icons/res/jumpbridge.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.jumpbridgesButton.setIcon(icon11)
        ...
        icon12 = QIcon()
        icon12.addFile(u":/Icons/res/statistic.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.statisticsButton.setIcon(icon12)
        ...
        icon13 = QIcon()
        icon13.addFile(u":/Icons/res/adm_vul.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.adm_vul_Button.setIcon(icon13)
        ...
        self.rescanIntel.setIcon(icon4)
        ...
        self.chatLargeButton.setIcon(icon9)
        ...
        self.chatSmallButton.setIcon(icon10)
        ...
        icon14 = QIcon()
        icon14.addFile(u"res/eve-sso-login-black-small.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.connectToEveOnline.setIcon(icon14)
        ...
        icon15 = QIcon()
        icon15.addFile(u":/Icons/res/route.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolUseTheraRouting.setIcon(icon15)
        ...
        self.toolRescanThrea.setIcon(icon4)
        ...
        self.toolRescanStorm.setIcon(icon4)
        ...
        self.jumpbridgesButton.clicked.connect(MainWindow.changeJumpbridgesVisibility)
        self.statisticsButton.clicked.connect(MainWindow.changeStatisticsVisibility)
        self.adm_vul_Button.clicked.connect(MainWindow.changeADMVisibility)
...
#if QT_CONFIG(tooltip)
        self.actionShowChatAvatars.setToolTip(QCoreApplication.translate("MainWindow", u"Show the avatars in the chat log window.", None))
#endif // QT_CONFIG(tooltip)
