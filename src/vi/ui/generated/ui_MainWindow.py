...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon19 = QIcon()
        icon19.addFile(u"res/eve-sso-login-black-small.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.connectToEveOnline.setIcon(icon19)
        ...
        icon20 = QIcon()
        icon20.addFile(u":/Icons/res/route.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolUseTheraRouting.setIcon(icon20)
