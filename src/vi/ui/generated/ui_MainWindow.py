...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon1 = QIcon()
        icon1.addFile(u":/Icons/res/avatar_off.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon1.addFile(u":/Icons/res/avatar.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.actionShowChatAvatars.setIcon(icon1)
        self.actionShowTabs = QAction(MainWindow)
        self.actionShowTabs.setObjectName(u"actionShowTabs")
        self.actionShowTabs.setCheckable(True)
        self.actionShowTabs.setChecked(True)
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Icons/res/volume_off.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon2.addFile(u":/Icons/res/volume.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        self.actionAutoSwitchRegions.setChecked(True)
        self.actionAutoSwitchRegions.setEnabled(True)
        icon6 = QIcon()
        icon6.addFile(u":/Icons/res/auto_center_off.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon6.addFile(u":/Icons/res/auto_center.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.actionAutoSwitchRegions.setIcon(icon6)
        ...
        icon8 = QIcon()
        icon8.addFile(u":/Icons/res/adm_vul_off.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon8.addFile(u":/Icons/res/adm_vul.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon9 = QIcon()
        icon9.addFile(u":/Icons/res/statistic_off.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon9.addFile(u":/Icons/res/statistic.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        ...
        icon10 = QIcon()
        icon10.addFile(u":/Icons/res/jumpbridge_off.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        icon10.addFile(u":/Icons/res/jumpbridge.svg", QSize(), QIcon.Mode.Normal, QIcon.State.On)
        self.actionShowJumpBridgeConnectionsOnMap.setIcon(icon10)
        self.actionAlarm_distance_0 = QAction(MainWindow)
        self.actionAlarm_distance_0.setObjectName(u"actionAlarm_distance_0")
        self.actionAlarm_distance_0.setCheckable(True)
        self.actionAlarm_distance_0.setProperty(u"distance", 0)
        self.actionAlarm_distance_1 = QAction(MainWindow)
        self.actionAlarm_distance_1.setObjectName(u"actionAlarm_distance_1")
        self.actionAlarm_distance_1.setCheckable(True)
        self.actionAlarm_distance_1.setProperty(u"distance", 1)
        self.actionAlarm_distance_2 = QAction(MainWindow)
        self.actionAlarm_distance_2.setObjectName(u"actionAlarm_distance_2")
        self.actionAlarm_distance_2.setCheckable(True)
        self.actionAlarm_distance_2.setProperty(u"distance", 2)
        self.actionAlarm_distance_3 = QAction(MainWindow)
        self.actionAlarm_distance_3.setObjectName(u"actionAlarm_distance_3")
        self.actionAlarm_distance_3.setCheckable(True)
        self.actionAlarm_distance_3.setProperty(u"distance", 3)
        self.actionAlarm_distance_4 = QAction(MainWindow)
        self.actionAlarm_distance_4.setObjectName(u"actionAlarm_distance_4")
        self.actionAlarm_distance_4.setCheckable(True)
        self.actionAlarm_distance_4.setProperty(u"distance", 4)
        self.actionAlarm_distance_5 = QAction(MainWindow)
        self.actionAlarm_distance_5.setObjectName(u"actionAlarm_distance_5")
        self.actionAlarm_distance_5.setCheckable(True)
        self.actionAlarm_distance_5.setProperty(u"distance", 5)
        self.actionChange_Region_to = QAction(MainWindow)
        self.actionChange_Region_to.setObjectName(u"actionChange_Region_to")
        self.actionOpen_on_dotlan = QAction(MainWindow)
        self.actionOpen_on_dotlan.setObjectName(u"actionOpen_on_dotlan")
        self.actionOpen_on_zKillboard = QAction(MainWindow)
        self.actionOpen_on_zKillboard.setObjectName(u"actionOpen_on_zKillboard")
        self.actionIntel_Time_5_min = QAction(MainWindow)
        self.actionIntel_Time_5_min.setObjectName(u"actionIntel_Time_5_min")
        self.actionIntel_Time_5_min.setCheckable(True)
        self.actionIntel_Time_5_min.setProperty(u"time", 5)
        self.actionIntel_Time_10_min = QAction(MainWindow)
        self.actionIntel_Time_10_min.setObjectName(u"actionIntel_Time_10_min")
        self.actionIntel_Time_10_min.setCheckable(True)
        self.actionIntel_Time_10_min.setProperty(u"time", 10)
        self.actionIntel_Time_20_min = QAction(MainWindow)
        self.actionIntel_Time_20_min.setObjectName(u"actionIntel_Time_20_min")
        self.actionIntel_Time_20_min.setCheckable(True)
        self.actionIntel_Time_20_min.setProperty(u"time", 20)
        self.actionIntel_Time_30_min = QAction(MainWindow)
        self.actionIntel_Time_30_min.setObjectName(u"actionIntel_Time_30_min")
        self.actionIntel_Time_30_min.setCheckable(True)
        self.actionIntel_Time_30_min.setProperty(u"time", 30)
        self.actionIntel_Time_60_min = QAction(MainWindow)
        self.actionIntel_Time_60_min.setObjectName(u"actionIntel_Time_60_min")
        self.actionIntel_Time_60_min.setCheckable(True)
        self.actionIntel_Time_60_min.setProperty(u"time", 60)
        self.actionSlyle_abyss = QAction(MainWindow)
        self.actionSlyle_abyss.setObjectName(u"actionSlyle_abyss")
        self.actionStyle_light = QAction(MainWindow)
        self.actionStyle_light.setObjectName(u"actionStyle_light")
        self.actionClear_Intel_Chat = QAction(MainWindow)
        self.actionClear_Intel_Chat.setObjectName(u"actionClear_Intel_Chat")
        icon11 = QIcon()
        icon11.addFile(u":/Icons/res/trash-box.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.actionClear_Intel_Chat.setIcon(icon11)
        self.actionOpacity_100 = QAction(MainWindow)
        self.actionOpacity_100.setObjectName(u"actionOpacity_100")
        self.actionOpacity_100.setCheckable(True)
        self.actionOpacity_80 = QAction(MainWindow)
        self.actionOpacity_80.setObjectName(u"actionOpacity_80")
        self.actionOpacity_80.setCheckable(True)
        self.actionOpacity_60 = QAction(MainWindow)
        self.actionOpacity_60.setObjectName(u"actionOpacity_60")
        self.actionOpacity_60.setCheckable(True)
        self.actionOpacity_40 = QAction(MainWindow)
        self.actionOpacity_40.setObjectName(u"actionOpacity_40")
        self.actionOpacity_40.setCheckable(True)
        ...
        self.frameButton.setMaximumSize(QSize(32, 32))
        font = QFont()
        font.setPointSize(11)
        self.frameButton.setFont(font)
        self.frameButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        ...
        self.searchSystem.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        icon12 = QIcon()
        icon12.addFile(u":/Icons/res/search.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.searchSystem.setIcon(icon12)
        ...
        self.regionNameField.setInsertPolicy(QComboBox.InsertPolicy.NoInsert)
        self.regionNameField.setSizeAdjustPolicy(QComboBox.SizeAdjustPolicy.AdjustToContents)
        ...
        self.autoCenterChar = QToolButton(self.mapbuttonwidget)
        self.autoCenterChar.setObjectName(u"autoCenterChar")
        self.autoCenterChar.setText(u"")
#if QT_CONFIG(shortcut)
        self.autoCenterChar.setShortcut(u"")
#endif // QT_CONFIG(shortcut)
        self.autoCenterChar.setAutoRaise(True)

        self.horizontalLayout_2.addWidget(self.autoCenterChar)
        ...
        self.locateChar.setMinimumSize(QSize(32, 32))
        self.locateChar.setMaximumSize(QSize(32, 32))
        self.locateChar.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        icon13 = QIcon()
        icon13.addFile(u":/Icons/res/locate.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.locateChar.setIcon(icon13)
        ...
        self.zoomInButton.setMinimumSize(QSize(32, 32))
        self.zoomInButton.setMaximumSize(QSize(32, 32))
        self.zoomInButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        icon14 = QIcon()
        icon14.addFile(u":/Icons/res/plus.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.zoomOutButton.setMinimumSize(QSize(32, 32))
        ...
        icon15 = QIcon()
        icon15.addFile(u":/Icons/res/minus.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        ...
        self.jumpbridgesButton.setMinimumSize(QSize(0, 32))
        self.jumpbridgesButton.setMaximumSize(QSize(48, 32))
        self.jumpbridgesButton.setFont(font)
        self.jumpbridgesButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        icon16 = QIcon()
        icon16.addFile(u":/Icons/res/jumpbridge.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.jumpbridgesButton.setIcon(icon16)
        ...
        self.statisticsButton.setMinimumSize(QSize(0, 32))
        self.statisticsButton.setMaximumSize(QSize(48, 32))
        self.statisticsButton.setFont(font)
        self.statisticsButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        icon17 = QIcon()
        icon17.addFile(u":/Icons/res/statistic.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.statisticsButton.setIcon(icon17)
        ...
        self.adm_vul_Button.setMinimumSize(QSize(0, 32))
        self.adm_vul_Button.setMaximumSize(QSize(48, 32))
        self.adm_vul_Button.setFont(font)
        self.adm_vul_Button.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        icon18 = QIcon()
        icon18.addFile(u":/Icons/res/adm_vul.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.adm_vul_Button.setIcon(icon18)
        ...
        self.menubar.setGeometry(QRect(0, 0, 1472, 24))
        ...
        self.menuAlarm_distance = QMenu(self.menuIntel)
        self.menuAlarm_distance.setObjectName(u"menuAlarm_distance")
        self.menuType_Here_2 = QMenu(self.menuIntel)
        self.menuType_Here_2.setObjectName(u"menuType_Here_2")
        MainWindow.setMenuBar(self.menubar)
        self.dockWidget = QDockWidget(MainWindow)
        self.dockWidget.setObjectName(u"dockWidget")
        self.dockWidget.setFloating(False)
        self.dockWidget.setFeatures(QDockWidget.DockWidgetFeature.DockWidgetClosable|QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.clearIntel.setMinimumSize(QSize(36, 36))
        self.clearIntel.setMaximumSize(QSize(36, 36))
        self.clearIntel.setIcon(icon11)
        ...
        self.rescanIntel.setMinimumSize(QSize(36, 36))
        self.rescanIntel.setMaximumSize(QSize(36, 36))
        ...
        self.chatLargeButton.setMinimumSize(QSize(36, 36))
        self.chatLargeButton.setMaximumSize(QSize(36, 36))
        self.chatLargeButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.chatLargeButton.setIcon(icon14)
        ...
        self.chatSmallButton.setMinimumSize(QSize(36, 36))
        self.chatSmallButton.setMaximumSize(QSize(36, 36))
        self.chatSmallButton.setFocusPolicy(Qt.FocusPolicy.NoFocus)
        self.chatSmallButton.setIcon(icon15)
        ...
        self.showAvatar.setMinimumSize(QSize(36, 36))
        self.showAvatar.setMaximumSize(QSize(36, 36))
        icon19 = QIcon()
        icon19.addFile(u":/Icons/res/avatar.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.showAvatar.setIcon(icon19)
        ...
        self.chatListWidget.setContextMenuPolicy(Qt.ContextMenuPolicy.ActionsContextMenu)
        self.chatListWidget.setFrameShadow(QFrame.Shadow.Plain)
        self.chatListWidget.setHorizontalScrollBarPolicy(Qt.ScrollBarPolicy.ScrollBarAsNeeded)
        self.chatListWidget.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.chatListWidget.setSelectionMode(QAbstractItemView.SelectionMode.NoSelection)
        self.chatListWidget.setTextElideMode(Qt.TextElideMode.ElideNone)
        self.chatListWidget.setHorizontalScrollMode(QAbstractItemView.ScrollMode.ScrollPerPixel)
        self.chatListWidget.setResizeMode(QListView.ResizeMode.Adjust)
        ...
        self.dockWidget_2.setFeatures(QDockWidget.DockWidgetFeature.DockWidgetClosable|QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.tableViewPOIs.setEditTriggers(QAbstractItemView.EditTrigger.DoubleClicked)
        ...
        self.tableViewPOIs.setDragDropMode(QAbstractItemView.DragDropMode.DragDrop)
        self.tableViewPOIs.setSelectionMode(QAbstractItemView.SelectionMode.ContiguousSelection)
        self.tableViewPOIs.setTextElideMode(Qt.TextElideMode.ElideNone)
        ...
        self.dockWidget_3.setFeatures(QDockWidget.DockWidgetFeature.DockWidgetClosable|QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.tableViewJBs.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        ...
        self.tableViewJBs.setSelectionMode(QAbstractItemView.SelectionMode.ContiguousSelection)
        self.tableViewJBs.setSelectionBehavior(QAbstractItemView.SelectionBehavior.SelectRows)
        self.tableViewJBs.setTextElideMode(Qt.TextElideMode.ElideNone)
        self.tableViewJBs.setGridStyle(Qt.PenStyle.SolidLine)
        ...
        self.dockWidget_4.setFeatures(QDockWidget.DockWidgetFeature.DockWidgetClosable|QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        icon20 = QIcon()
        icon20.addFile(u"res/eve-sso-login-black-small.png", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.connectToEveOnline.setIcon(icon20)
        ...
        self.removeChar.setMinimumSize(QSize(32, 32))
        self.removeChar.setMaximumSize(QSize(32, 32))
        self.removeChar.setIcon(icon11)
        ...
        self.tableChars.setTextElideMode(Qt.TextElideMode.ElideNone)
        ...
        self.clearCache.setMinimumSize(QSize(32, 32))
        self.clearCache.setMaximumSize(QSize(32, 32))
        self.clearCache.setIcon(icon11)
        ...
        self.dockWidget_5.setMinimumSize(QSize(270, 127))
        self.dockWidget_5.setFeatures(QDockWidget.DockWidgetFeature.DockWidgetClosable|QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.toolUseTheraRouting.setMinimumSize(QSize(32, 32))
        self.toolUseTheraRouting.setMaximumSize(QSize(32, 32))
        icon21 = QIcon()
        icon21.addFile(u":/Icons/res/route.svg", QSize(), QIcon.Mode.Normal, QIcon.State.Off)
        self.toolUseTheraRouting.setIcon(icon21)
        ...
        self.toolRescanThrea.setMinimumSize(QSize(32, 32))
        self.toolRescanThrea.setMaximumSize(QSize(32, 32))
        ...
        self.tableViewThera.setEditTriggers(QAbstractItemView.EditTrigger.NoEditTriggers)
        self.tableViewThera.setTextElideMode(Qt.TextElideMode.ElideNone)
        ...
        self.dockWidget_6.setMinimumSize(QSize(270, 131))
        self.dockWidget_6.setFeatures(QDockWidget.DockWidgetFeature.DockWidgetClosable|QDockWidget.DockWidgetFeature.DockWidgetMovable)
        ...
        self.toolRescanStorm.setMinimumSize(QSize(32, 32))
        self.toolRescanStorm.setMaximumSize(QSize(32, 32))
        ...
        self.tableViewStorm.setTextElideMode(Qt.TextElideMode.ElideNone)
        ...
        self.menuWindow.addAction(self.actionShowTabs)
        ...
        self.menuTransparency.addAction(self.actionOpacity_100)
        self.menuTransparency.addAction(self.actionOpacity_80)
        self.menuTransparency.addAction(self.actionOpacity_60)
        self.menuTransparency.addAction(self.actionOpacity_40)
        self.menuTransparency.addAction(self.actionOpacity_20)
        self.menuIntel.addAction(self.menuChars.menuAction())
        self.menuIntel.addAction(self.menuTime.menuAction())
        self.menuIntel.addAction(self.actionClear_Intel_Chat)
        self.menuIntel.addAction(self.actionRescanIntelNow)
        self.menuIntel.addSeparator()
        self.menuIntel.addAction(self.menuAlarm_distance.menuAction())
        self.menuIntel.addAction(self.menuType_Here_2.menuAction())
        self.menuTime.addSeparator()
        self.menuTime.addAction(self.actionIntel_Time_5_min)
        self.menuTime.addAction(self.actionIntel_Time_10_min)
        self.menuTime.addAction(self.actionIntel_Time_20_min)
        self.menuTime.addAction(self.actionIntel_Time_30_min)
        self.menuTime.addAction(self.actionIntel_Time_60_min)
        self.menuAlarm_distance.addAction(self.actionAlarm_distance_0)
        self.menuAlarm_distance.addAction(self.actionAlarm_distance_1)
        self.menuAlarm_distance.addAction(self.actionAlarm_distance_2)
        self.menuAlarm_distance.addAction(self.actionAlarm_distance_3)
        self.menuAlarm_distance.addAction(self.actionAlarm_distance_4)
        self.menuAlarm_distance.addAction(self.actionAlarm_distance_5)
        ...
        self.actionShowTabs.triggered["bool"].connect(self.dockWidget.setVisible)
        self.actionShowTabs.toggled.connect(self.dockWidget_2.setVisible)
        self.actionShowTabs.toggled.connect(self.dockWidget_3.setVisible)
        self.actionShowTabs.toggled.connect(self.dockWidget_4.setVisible)
    ...
    def retranslateUi(self, MainWindow):
...
#endif // QT_CONFIG(tooltip)
        self.actionShowTabs.setText(QCoreApplication.translate("MainWindow", u"Show Tabs", None))
        ...
        self.actionAutoSwitchRegions.setText(QCoreApplication.translate("MainWindow", u"Auto  follow character", None))
        ...
        self.actionAlarm_distance_0.setText(QCoreApplication.translate("MainWindow", u"Alarm distance 0", None))
        self.actionAlarm_distance_1.setText(QCoreApplication.translate("MainWindow", u"Alarm distance 1", None))
        self.actionAlarm_distance_2.setText(QCoreApplication.translate("MainWindow", u"Alarm distance 2", None))
        self.actionAlarm_distance_3.setText(QCoreApplication.translate("MainWindow", u"Alarm distance 3", None))
        self.actionAlarm_distance_4.setText(QCoreApplication.translate("MainWindow", u"Alarm distance 4", None))
        self.actionAlarm_distance_5.setText(QCoreApplication.translate("MainWindow", u"Alarm distance 5", None))
        self.actionChange_Region_to.setText(QCoreApplication.translate("MainWindow", u"Change Region to", None))
        self.actionOpen_on_dotlan.setText(QCoreApplication.translate("MainWindow", u"Open on dotlan", None))
        self.actionOpen_on_zKillboard.setText(QCoreApplication.translate("MainWindow", u"Open on zKillboard", None))
        self.actionIntel_Time_5_min.setText(QCoreApplication.translate("MainWindow", u"Past 5 min", None))
        self.actionIntel_Time_10_min.setText(QCoreApplication.translate("MainWindow", u"Past 10 min", None))
        self.actionIntel_Time_20_min.setText(QCoreApplication.translate("MainWindow", u"Past 20 min", None))
        self.actionIntel_Time_30_min.setText(QCoreApplication.translate("MainWindow", u"Past 30 min", None))
        self.actionIntel_Time_60_min.setText(QCoreApplication.translate("MainWindow", u"Past 60 min", None))
        self.actionSlyle_abyss.setText(QCoreApplication.translate("MainWindow", u"Abyss", None))
#if QT_CONFIG(tooltip)
        self.actionSlyle_abyss.setToolTip(QCoreApplication.translate("MainWindow", u"Select the dark abyss style.", None))
#endif // QT_CONFIG(tooltip)
        self.actionSlyle_abyss.setProperty(u"style", QCoreApplication.translate("MainWindow", u"abyss", None))
        self.actionStyle_light.setText(QCoreApplication.translate("MainWindow", u"Light", None))
#if QT_CONFIG(tooltip)
        self.actionStyle_light.setToolTip(QCoreApplication.translate("MainWindow", u"Select the light style", None))
#endif // QT_CONFIG(tooltip)
        self.actionStyle_light.setProperty(u"style", QCoreApplication.translate("MainWindow", u"light", None))
        self.actionClear_Intel_Chat.setText(QCoreApplication.translate("MainWindow", u"Clear Intel Chat", None))
        self.actionOpacity_100.setText(QCoreApplication.translate("MainWindow", u"Opacity 100%", None))
        self.actionOpacity_80.setText(QCoreApplication.translate("MainWindow", u"Opacity 80%", None))
        ...
        self.menuAlarm_distance.setTitle(QCoreApplication.translate("MainWindow", u"Alarm distance", None))
        self.menuType_Here_2.setTitle(QCoreApplication.translate("MainWindow", u"Type Here", None))
