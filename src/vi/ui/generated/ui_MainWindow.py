...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        icon2 = QIcon()
        icon2.addFile(u":/Icons/res/plus.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon3 = QIcon()
        icon3.addFile(u":/Icons/res/minus.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        self.jumpbridgesButton.setMaximumSize(QSize(64, 32))
        self.jumpbridgesButton.setFont(font)
        self.jumpbridgesButton.setFocusPolicy(Qt.NoFocus)
        icon4 = QIcon()
        icon4.addFile(u":/Icons/res/jumpbridge.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.jumpbridgesButton.setIcon(icon4)
        ...
        self.statisticsButton.setMaximumSize(QSize(64, 32))
        self.statisticsButton.setFont(font)
        self.statisticsButton.setFocusPolicy(Qt.NoFocus)
        icon5 = QIcon()
        icon5.addFile(u":/Icons/res/statistic.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.statisticsButton.setIcon(icon5)
        ...
        self.chatLargeButton.setIcon(icon2)
        ...
        self.chatSmallButton.setIcon(icon3)
        ...
        icon6 = QIcon()
        icon6.addFile(u":/Icons/res/trash-box.svg", QSize(), QIcon.Normal, QIcon.Off)
        ...
        icon7 = QIcon()
        icon7.addFile(u":/Icons/res/arrows-rotate.svg", QSize(), QIcon.Normal, QIcon.Off)
        self.toolRescanThrea.setIcon(icon7)
