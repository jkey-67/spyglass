class CTX:
    ...
    FORMAT_PLAYER_NAME = u""" <a  style="color:#d0d0d0;font-weight:bold" href="link/https://zkillboard.com/character/{1}/">{0}</a> """
    FORMAT_ALLIANCE_NAME = u""" <a  style="color:#d0d0d0;font-weight:bold" href="link/https://zkillboard.com/alliance/{1}/">{0}</a> """
