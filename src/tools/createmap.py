...
#  Copyright (C) 2021 J.Keymer  (xxxxxxxxxxxxxxxxxx@gmx.com )             #
#																		  #
...
def createSvgFile( region_ids ):
    use_cache=True
    svg_template = loadSvg("/home/jkeymer/projects/spyglass/src/vi/ui/res/mapdata/MapTemplate.svg")
    jumps = svg_template.select("#jumps")[0]
    systemUses = svg_template.select("#sysuse")[0]
...
def main():
    #result = svgFileToDot("/home/jkeymer/projects/spyglass/src/vi/ui/res/mapdata/New_Combined-step_6.svg")
    #with open("/home/jkeymer/projects/spyglass/src/vi/ui/res/mapdata/Denci_Tactical.dot", "wb") as svgFile:
    #    svgFile.write(result.encode("utf-8"))
    #    svgFile.close()
    #return
    #newSvg =  createSvgFile(list({10000006,10000009, 10000008, 10000011}))
    newSvg = updateSvgFile("/home/jkeymer/projects/spyglass/src/vi/ui/res/mapdata/New_Combined-step_6.svg")
    result = newSvg.body.next.prettify().encode("utf-8")
    with open("/home/jkeymer/projects/spyglass/src/vi/ui/res/mapdata/Denci_Tactical.svg", "wb") as svgFile:
